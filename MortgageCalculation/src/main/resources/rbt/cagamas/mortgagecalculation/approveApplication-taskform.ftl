<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("mortgageout");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid mortgageout");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: MortgageCalculationProcess.approveApplication
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">mortgagein</label>
                            		<div class="div_checkbox">
                              		${mortgagein}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">mortgageout</label>
                            		<div class="div_texbox">
                              		<input name="mortgageout" type="text" class="textbox" id="mortgageout" value="${mortgageout}" />
                            		</div>
